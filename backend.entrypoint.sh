...
# ANGEPASST: Unser User-Modell (authentication.User) nutzt E-Mail statt Username
# als USERNAME_FIELD und besitzt kein username-Feld. Deshalb wird hier nach
# E-Mail gefiltert/erstellt statt nach Username.
